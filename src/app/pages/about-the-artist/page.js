...
export const metadata = {
	...
	description:
		"About Swati Ranka, artist dedicated to the exploration of diverse styles, subjects, and mediums.",
};
...
export default function AboutTheArtistPage() {
	return (
		<>
			...
			<div className="page-width py-10 lg:py-16">
				<div className="max-w-3xl mx-auto text-center">
					<h2 className="font-heading text-[2.6rem] lg:text-[3.2rem] text-[#121212] mb-6 tracking-wide font-light">
						About The Artist
					</h2>

					<div className="text-[rgba(0,0,0,0.6)] font-body text-center mx-auto tracking-[0.05em]">
						<p className="mb-6 leading-[2] text-[1.4rem] lg:text-[1.5rem]">
						...
						<p className="mt-6 text-[1.4rem] lg:text-[1.5rem] leading-relaxed">- Swati</p>
					</div>
				</div>
			</div>
		</>
